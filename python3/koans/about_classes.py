...
class AboutClasses(Koan):
    ...
    def test_classes_have_docstrings(self):
        self.assertRegex(self.Dog.__doc__, "regular walkies. Never, ever let them drive")
    ...
    def test_args_must_match_init(self):
        ...
        # THINK ABOUT IT:
        # Why is this so? B/c Dog5() is not a no-arg constructor
    ...
    def test_repr_provides_a_more_complete_string_version(self):
        fido = self.Dog6("Fido")
        self.assertEqual(f"<Dog named '{fido.get_self()}'>", repr(fido))
