...
class AboutControlStatements(Koan):
    ...
    def test_if_then_statements(self):
        ...
        if True:
            result = 'true value due to if'
        self.assertEqual('true value due to if', result)

    def test_if_then_elif_else_statements(self):
        if False:
            result = 'first value'
        elif True:
            result = 'true value due to elif'
        else:
            result = 'default value'
        self.assertEqual('true value due to elif', result)
    ...
    def test_for_statement_with_tuples(self):
        ...
        for knight, answer in round_table:
            result.append(f"Contestant: '{knight}'   Answer: '{answer}'")

        text = f"Contestant: '{round_table[2][0]}'   Answer: '{round_table[2][1]}'"
