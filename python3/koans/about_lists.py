...
class AboutLists(Koan):
    ...
    def test_slicing_lists(self):
        noms = ['noodle', 'dumpling', 'and', 'rice']

        # slice is from start to end (exclusive). End index is excluded
        self.assertEqual(["noodle"], noms[0:1])
        self.assertEqual(["noodle", "dumpling"], noms[0:2])
        # if start of slice = end of slice, it results in a singleton array
        self.assertEqual([], noms[2:2])
        # End of slice may be greater than length of array. Therefore the slice selects the remainder.
        self.assertEqual(["and", "rice"], noms[2:20])
        # Starter of slice may be greater than length of array. Therefore the slice selects the nothing.
        # End of slice may be less than the start of the slice too.
    ...
    def test_making_queues(self):
        ...
        self.assertEqual(deque(['last']), _deque)
