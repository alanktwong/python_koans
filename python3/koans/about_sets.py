...
class AboutSets(Koan):
    ...
    def test_dictionaries_and_sets_use_same_curly_braces(self):
        ...
        self.assertEqual(type(set()), {1, 2, 3}.__class__)
        self.assertEqual(type({}), {'one': 1, 'two': 2}.__class__)

        self.assertEqual(type({}), {}.__class__)
    ...
    def test_convert_the_set_into_a_list_to_sort_it(self):
        self.assertEqual(list('12345'), sorted(set('51234')))
    ...
    def test_we_can_compare_subsets(self):
        ...
        # But note how the palindrome on the characters in the string works
        self.assertEqual(True, set('cake') > set('ea'))
        self.assertEqual(False, {'cake'} <= {'cherry cake'})
        self.assertEqual(True, {'cake'} <= {'cherry', 'cake'})
        self.assertEqual(False, {'cake'}.issubset({'cherry cake'}) )
        self.assertEqual(True, {'cake'}.issubset({'cherry', 'cake'}) )
